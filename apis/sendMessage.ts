...
import { apiFactory, getClientMessageType, getFileExtension, resolveResponse } from "../src/utils";
import { ZaloApiError } from "../src/errors/ZaloApiErros";
import FormData from "form-data";
import fs from "node:fs/promises";
import { GroupMessage, UserMessage } from "../src/models/Message";
import { ThreadType } from "../src/models/Enum";
...
export const sendMessageFactory = apiFactory()((api, ctx, utils) => {
    ...
    //     let buffer = readFileSync(filePath) as any;
